...
//	Input values
	...
	//o valor do state 0000000000000000 codificado pelo present é 4584227b38c17955				   
	volatile uint8_t state[] = {0x45,0x84,0x22,0x7b,0x38,0xc1,0x79,0x55};
//	Counter
	uint8_t i = 0;
//	pLayer variables
	uint8_t position = 0;
...
//	****************** End Encryption **********************
	printf("esta assim: ");
	for(i=0;i<8;i++) printf("%x",state[i]);
	return 0;
}
